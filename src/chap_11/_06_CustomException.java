    ...
    public static void main(String[] args) {
        ...
        try {
            if (age < 19) {
                ...
                throw new AgeLessThan19Exception("만 19세 미만에게는 판매하지 않습니다."); // 의도적 에러 발생
            } else {
...
class AgeLessThan19Exception extends Exception { // 결국 Exception e 에다가 message를 넣어줘서 부모클래스에 주기에 그게 그거같음
